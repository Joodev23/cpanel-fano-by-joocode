...
async function handlePanelSubmit(e) {
  ...
  const diskValues = {
    "1gb": 10240, "2gb": 20480, "3gb": 30720, "4gb": 40960,
    "5gb": 51200, "6gb": 61440, "7gb": 71680, "8gb": 81920,
    "9gb": 92160, "10gb": 102400, "unlimited": 0
  };
...
async function handleAdminSubmit(e) {
  ...
  try {
    ...
    if (data.error || data.errors) {
      showResult(resultBox, "Gagal: " + (data.error || data.errors), "error");
      return;
    }
